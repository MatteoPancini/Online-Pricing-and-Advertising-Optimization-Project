...
class Environment:
    def __init__(self, user_class):
        ...
        self.cum_costs = self.get_total_costs(bids=self.bids, user_class=user_class)
    ...
    def get_total_costs(self, bids, user_class, noise_std_cost = 200):
    ...
    def get_total_cost(self, bid, user_class, noise_std_cost = 200):
    ...
    def round(self, pulled_bids_arm, pulled_prices_arm):
        ...
        n_clicks = max(0, int(self.generate_observation(self.user_class, noise_std_clicks=10, bid=bid)))
        cum_cost = self.get_total_cost(bid=bid, user_class=self.user_class)
